...
// MARK: - Unused API Calls
//
//extension RFWebService {
//
//    func getTrips(completion: @escaping CompletionHandler<[TripResult]>) {
//        guard let userID = profileController.authenticatedUserProfile?.id else {
//            completion(.failure(.noAuth))
//            return
//        }
//
//        let endpointURL = Endpoints.tripsByUserId(userID).url
//
//        guard let request = router.makeURLRequest(method: .get, endpointURL: endpointURL, bearer: bearer) else {
...
//    }
//
//    func getAllEvents(completion: @escaping CompletionHandler<[EventResult]>) {
//        guard let userID = profileController.authenticatedUserProfile?.id else {
//            completion(.failure(.noAuth))
//            return
//        }
//
//        let endpointURL = Endpoints.itemsByUserId(userID).url
//
//        guard let request = router.makeURLRequest(method: .get, endpointURL: endpointURL, bearer: bearer) else {
//            completion(.failure(.badRequest))
//            return
