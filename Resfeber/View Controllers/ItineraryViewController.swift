...
extension ItineraryViewController: UICollectionViewDataSource {
    func collectionView(_: UICollectionView, numberOfItemsInSection _: Int) -> Int {
        destinationController.itineraryDestinations.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard indexPath.row < destinationController.itineraryDestinations.count else { return DestinationCell() }

        cell.destination = destinationController.itineraryDestinations[indexPath.row]
...
extension ItineraryViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        guard indexPath.row < destinationController.itineraryDestinations.count else { return }
        let destination = destinationController.itineraryDestinations[indexPath.row]
